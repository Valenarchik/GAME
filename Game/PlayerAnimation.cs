    ...
    public partial class MyForm : Form
    {
        public void PlayerAnimation(Graphics g)
        {
            if (game.Player.IsMoving)
                ...
                {
                    case Directions.Up:
                        DrawAnimation(g, game.Player, Sprites.Chef.MoveUp1, Sprites.Chef.StandUp,
                            Sprites.Chef.MoveUp2, Sprites.Chef.StandUp);
                        break;
                    ...
                    case Directions.Down:
                        DrawAnimation(g, game.Player, Sprites.Chef.MoveDown1, Sprites.Chef.StandDown,
                            Sprites.Chef.MoveDown2, Sprites.Chef.StandDown);
                        break;
                    case Directions.Left:
                        DrawAnimation(g, game.Player, Sprites.Chef.MoveLeft1, Sprites.Chef.StandLeft,
                            Sprites.Chef.MoveLeft2, Sprites.Chef.StandLeft);
                        break;
                }
            else
            {
